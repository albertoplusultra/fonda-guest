...
const T: Record<LangCode, Translations> = {
  es: {
    ...
    detail: {
      ...
      experiencias_civitatis: "https://www.civitatis.com/es/madrid/",
      wifi_title: "WiFi",
  ...
  en: {
    ...
    detail: {
      ...
      experiencias_civitatis: "https://www.civitatis.com/en/madrid/",
      wifi_title: "WiFi",
  ...
  fr: {
    ...
    detail: {
      ...
      experiencias_civitatis: "https://www.civitatis.com/fr/madrid/",
      wifi_title: "WiFi",
  ...
  it: {
    ...
    detail: {
      ...
      experiencias_civitatis: "https://www.civitatis.com/it/madrid/",
      wifi_title: "WiFi",
