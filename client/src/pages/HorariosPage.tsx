...
const SCHEDULE_DATA: Record<string, ScheduleRow[]> = {
  es: [
    ...
    { label: "Desayuno",          rows: [
      ...
      { sublabel: "Sáb, Dom y festivos", value: "08:00 – 11:00 h" },
    ]},
  ...
  en: [
    ...
    { label: "Breakfast",         rows: [
      ...
      { sublabel: "Sat, Sun & holidays", value: "8:00 – 11:00 AM" },
    ]},
  ...
  fr: [
    ...
    { label: "Petit-déjeuner",    rows: [
      ...
      { sublabel: "Sam, Dim et jours fériés", value: "08h00 – 11h00" },
    ]},
    { label: "Bar & Restaurant",  rows: [
  ...
  de: [
    ...
    { label: "Frühstück",         rows: [
      ...
      { sublabel: "Sa, So und Feiertage", value: "08:00 – 11:00 Uhr" },
    ]},
    { label: "Bar & Restaurant",  rows: [
  ...
  it: [
    ...
    { label: "Colazione",         rows: [
      ...
      { sublabel: "Sab, Dom e festivi", value: "08:00 – 11:00" },
    ]},
  ...
  pt: [
    ...
    { label: "Café da manhã",     rows: [
      ...
      { sublabel: "Sáb, Dom e feriados", value: "08h00 – 11h00" },
    ]},
    { label: "Bar & Restaurante", rows: [
  ...
  zh: [
    ...
    { label: "早餐",               rows: [
      ...
      { sublabel: "周六、日及节假日", value: "08:00 – 11:00" },
    ]},
    { label: "酒吧 & 餐厅",        rows: [
  ...
  ja: [
    ...
    { label: "朝食",               rows: [
      ...
      { sublabel: "土・日・祝日",  value: "08:00 – 11:00" },
    ]},
    { label: "バー & レストラン",  rows: [
  ...
  ar: [
    ...
    { label: "الإفطار",           rows: [
      ...
      { sublabel: "السبت والأحد والعطل", value: "08:00 – 11:00" },
    ]},
  ...
  ru: [
    ...
    { label: "Завтрак",           rows: [
      ...
      { sublabel: "Сб, Вс и праздники", value: "08:00 – 11:00" },
    ]},
