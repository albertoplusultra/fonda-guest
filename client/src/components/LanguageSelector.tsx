        ...
        >
          {LANGUAGES.map((l) => (
            <button
              ...
              style={{
                fontFamily: "'DM Sans', sans-serif",
                color: l.code === lang ? "var(--gold)" : "oklch(0.70 0.015 85)",
                background: l.code === lang ? "oklch(0.14 0.04 72 / 0.4)" : "transparent",
                borderBottom: "1px solid oklch(0.16 0 0)",
              }}
              onMouseEnter={(e) => {
                if (l.code !== lang) {
                  (e.currentTarget as HTMLButtonElement).style.background = "oklch(0.14 0 0)";
                  (e.currentTarget as HTMLButtonElement).style.color = "oklch(0.88 0.025 85)";
                }
              }}
              onMouseLeave={(e) => {
                if (l.code !== lang) {
                  (e.currentTarget as HTMLButtonElement).style.background = "transparent";
                  (e.currentTarget as HTMLButtonElement).style.color = "oklch(0.70 0.015 85)";
                }
              }}
            >
