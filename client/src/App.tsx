...
// Wrapper components to adapt onBack / navigation props to URL-based routing
...
function Router() {
  ...
  return (
    ...
    <Switch>
      ...
      <Route path="/climati">
        <BackWrapper>{(onBack) => <ClimatiPage onBack={onBack} onContacto={() => setLocation("/contacto")} />}</BackWrapper>
      </Route>
      <Route path="/servicio">
        <BackWrapper>
          {(onBack) => (
